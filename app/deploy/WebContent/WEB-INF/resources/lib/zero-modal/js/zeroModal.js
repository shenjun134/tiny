...
(function(obj) {
    ...
    function _buildModal(opt) {
        ...
        _headerHtml += '        <div title="Close" zero-close-unique="' + opt.unique + '" class="zeromodal-close">×</div>';
        if (opt.max) {
            _headerHtml += '    <div title="Max/Unmax" zero-max-unique="' + opt.unique + '" class="zeromodal-max"></div>';
        }
