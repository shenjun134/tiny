...
public class SystemUtils {
    ...
    public static String getContextPath() {
        return new StringBuilder().append("/").append(getContextName()).toString();
    }
     ...
     * @return
     */
    public static String getHomeEntryPage() {
        return getSystemProperty(SystemPropertyEnum.HOME_ENTRY_PAGE);
    }

    public static boolean isHomePage(String uri) {
        String temp = StringUtils.removeEnd(uri, "#");
        return StringUtils.equals(getHomePage(), temp);
    }
